        ...
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.blue:
                        translationView.setShadowColor(ActivityCompat.getColor(EndActivity.this, R.color.blue));
                        break;
                    case R.id.red:
                        translationView.setShadowColor(ActivityCompat.getColor(EndActivity.this, R.color.red));
                        break;
                }
                return true;
            }
